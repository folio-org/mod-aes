...
public class AesConstants {
  ...
  public static final String CONFIG_ROUTING_QUERY =
      String.format("/configurations/entries?query=%s&limit=%d",
          CONFIG_QUERY_CQL, Integer.MAX_VALUE);
  ...
  public static final List<String> MSG_PW = List.of("password", "newPassword");
  ...
  public static final List<JsonPath> PII_JSON_PATHS = List.of(
